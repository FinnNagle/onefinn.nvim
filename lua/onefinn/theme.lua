...
function theme.highlights(colors, config)
  ...
  local function load_plugins()
    ...
    local plugins = {
      ...
      NvimTreeEmptyFolderName = { fg = colors.light_gray, style = "bold" },
      NvimTreeOpenedFolderName = { fg = colors.light_gray, style = "bold" },
      ...
      BufferCurrentMod = { fg = colors.blue, bg = colors.bg, style = "bold" },
      ...
      BufferVisibleMod = { fg = colors.blue, bg = colors.bg, style = "bold" },
      ...
      BufferInactiveMod = { fg = colors.blue, bg = colors.active },
